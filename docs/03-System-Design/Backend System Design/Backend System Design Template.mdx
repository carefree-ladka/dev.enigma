...
<img
  src="https://i.postimg.cc/02sYrPRn/system-design.png"
  alt="system design"
/>
...
_Note: Data Flow (step 4) is optional and only needed for data processing systems_
...
_"Users/Clients should be able to..." statements - core features of your system_
...
_"The system should be..." statements about system qualities_
...
_Only perform calculations if they directly influence your design_
...
_List the core entities that your API will exchange and system will persist_
...
_Define the contract between your system and its users_
...
_High-level sequence of actions for data processing systems_
...
_Draw boxes and arrows representing system components and interactions_
...
_Document relevant columns/fields next to database components_
...
_Iterate on design to meet non-functional requirements and address bottlenecks_
