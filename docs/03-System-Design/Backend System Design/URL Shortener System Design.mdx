...
- **Client** → **CDN** → **Regional Load Balancer** → **API Gateway** → **URL Service**
...
- **Client** → **CDN** (cache miss) → **Regional Load Balancer** → **URL Service**
