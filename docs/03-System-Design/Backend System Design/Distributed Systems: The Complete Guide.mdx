...
> **Interview Tip:** If interviewer asks _"What if an entire data center goes down?"_, answer:
>
...
When asked: _"How is your system fault tolerant?"_ — reply in this structure:
...
**Question:** _"How does WhatsApp ensure a message isn't lost if a server fails?"_
