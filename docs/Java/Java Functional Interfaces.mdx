...
- [1. `Predicate<T>`](#1-predicate-t)
- [2. `Function<T,R>`](#2-function-t-r)
- [3. `Consumer<T>`](#3-consumer-t)
- [4. `Supplier<T>`](#4-supplier-t)
- [5. `UnaryOperator<T>`](#5-unary-operator-t)
- [6. `BinaryOperator<T>`](#6-binary-operator-t)
