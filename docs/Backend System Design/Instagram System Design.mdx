...
- _Impact:_ Requires distributed object storage + CDN strategy

**Read vs Write Ratio:**

- Assumption: 100:1 read-to-write ratio (users browse much more than post)
- _Impact:_ Heavy caching and read replica strategy needed

**QPS Estimates:**

- 100M DAU × 50 feed refreshes/day = 5B requests/day ≈ 58K QPS average
- _Impact:_ Need horizontal scaling and load balancing
